  ...
  return (
    <>
      ...
      <div className="mx-auto flex w-full max-w-[1280px] flex-col px-5 py-16 sm:px-8">
        <h2 className="text-brand-secondary hidden text-center text-[7.2vw] italic sm:text-[5vw] xl:inline xl:text-start xl:text-4xl">
          A Estratégia por Trás dos Seus Resultados
        </h2>
        <div className="flex w-full flex-col gap-10 py-10 xl:flex-row xl:gap-5 xl:py-16">
          <h2 className="text-brand-secondary sticky top-11 -mt-10 text-center text-[7.2vw] italic sm:text-[5vw] xl:hidden">
            A Estratégia por Trás dos Seus Resultados
          </h2>
          <FeatureCard
            ...
            className="sticky top-[calc(164px)] sm:top-[calc(200px)] xl:static xl:top-auto"
          ...
          <FeatureCard
            ...
            className="sticky top-[calc(164px+20px)] sm:top-[calc(200px+20px)] xl:static xl:top-auto"
          ...
          <FeatureCard
            ...
            className="sticky top-[calc(164px+40px)] sm:top-[calc(200px+40px)] xl:static xl:top-auto"
          ...
          <FeatureCard
            ...
            className="sticky top-[calc(164px+60px)] sm:top-[calc(200px+60px)] xl:static xl:top-auto"
        ...
        <div className="flex w-full flex-col items-center justify-between gap-8 xl:flex-row xl:items-start xl:gap-0">
          {" "}
          <p className="text-brand-primary max-w-[460px] text-justify text-[3.6vw] italic sm:max-w-[60%] sm:text-[2vw] xl:max-w-[460px] xl:text-base">
