    ...
    <>
      ...
      <div className="mx-auto flex w-full max-w-[1280px] flex-col px-5 py-16 lg:px-8">
        ...
        <div className="flex w-full flex-col items-center justify-between gap-8 lg:flex-row lg:items-start lg:gap-0">
          {" "}
          <p className="text-brand-primary max-w-[460px] text-justify text-[3.6vw] italic lg:text-base">
          ...
          <Button className="transition-all duration-300 ease-out lg:[background:linear-gradient(257deg,#7A1520_4.53%,#FF5858_95.06%)] lg:hover:[background:linear-gradient(257deg,#9C1E28_4.53%,#FF6B6B_95.06%)]">
            marcar consulta
          </Button>
        </div>
      </div>
