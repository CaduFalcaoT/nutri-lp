...
export default function Footer() {
  return (
    <footer className="mx-auto flex w-full max-w-[1280px] flex-col items-center justify-between gap-12 px-8 py-16 sm:flex-row sm:gap-0">
      ...
      <div className="flex flex-col gap-8 px-8 opacity-90">
        <a target="blank" href="https://www.instagram.com/ceciliamelonutri/">
          <div className="text-brand-secondary flex items-center gap-2">
            <svg
              role="img"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
              className="fill-brand-secondary size-7"
            >
            ...
            <p>@ceciliamelonutri</p>
          </div>
        </a>
        <a href="mailto:nutriceciliamelo@gmail.com">
          <div className="text-brand-secondary flex items-center gap-2">
            <Mail className="text-brand-secondary size-7" />
            <p>nutriceciliamelo@gmail.com</p>
          </div>
        </a>
        <a href="tel:+5581983859495">
          <div className="text-brand-secondary flex items-center gap-2">
            <Phone className="text-brand-secondary size-7" />
            <p>+55 81 98385-9495</p>
          </div>
        </a>
      </div>
    </footer>
