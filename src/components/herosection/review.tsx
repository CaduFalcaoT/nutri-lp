...
export default function Review() {
  return (
    <div className="-mb-4 flex flex-col items-center gap-2 sm:flex-row">
      ...
      <div className="flex items-center gap-1 sm:flex-col sm:items-start sm:gap-0.5">
        <div className="flex">
        ...
        <p className="text-brand-primary -mb-1 text-[12px] uppercase italic opacity-90 sm:mb-0 sm:text-xs">
